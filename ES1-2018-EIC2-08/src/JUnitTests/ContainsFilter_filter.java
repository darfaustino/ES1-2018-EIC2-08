...
public class ContainsFilter_filter {
	...
	public void test() {
		...
		TwitterApp tw = new TwitterApp("W1f0VvgWPfT8OBqVxvy4Mw", "zKH2yAtRyefwsgOO8h8Szc4kru68iEm95QmIG7svw",
				"36481851-VhzByC4f9MSsZES1QZQ4e4iBvA9bWGLyv9HKFpy7c", "OahDuXF2Lhl5xlNYALhYZir6xSflAxKP9Zh89T05po");
		...
		try {
			...
			ContainsFilter u = new ContainsFilter(m.getFacePosts(), m.getEmails(), m.getTweets());
			String s = "de";
			try {
				u.containsFilter(s);
