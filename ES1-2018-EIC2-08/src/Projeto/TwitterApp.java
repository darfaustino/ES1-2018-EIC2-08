...
public final class TwitterApp {
	...
	/** Creates a TwitterFactory with all the informations we have about the tokens that we gave
	 * 
	 * 
	 */
...
//	/** Update "What are you doing?" via Twitter.updateStatus() method.
//	 * 
//	 * @param latestStatus is the new tweet to share
//	 * 
//	 */
//	public static void post(String latestStatus) throws TwitterException {
